...
export const Card = ({ item, index }: CardProps) => {
  ...
  return (
    <a
      ...
      aria-label={`Open ${item.address} in Google Maps`}
    >
      <article className="overflow-hidden rounded-2xl bg-white shadow-soft-lg transition-transform duration-200 hover:-translate-y-0.5">
